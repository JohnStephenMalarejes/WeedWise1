...
class WeatherFragment : Fragment() {
    ...
    val CITY: String = "Bilar,ph"
    val API: String = "31dd119da12b216a9cf0467e55a6a02e"
    ...
    inner class weatherTask(): AsyncTask<String, Void, String> ()
    {
        override fun onPreExecute() {
            ...
            view?.findViewById<RelativeLayout>(R.id.main_container)?.visibility = View.GONE
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                view?.findViewById<TextView>(R.id.update)?.text = updatedAtText
